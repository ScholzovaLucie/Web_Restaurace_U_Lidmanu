...
<body>
    ...
    <a onmouseleave="hideNodes(this)" id="index_navbar" href='index.html'>O nás</a>
        ...
        <btn onclick="location.href='kontakt.php';" id="jazykCZ"class="jazykCZaktivni">CZ</btn>
   ...
   <a id="up_restaurace" onclick="topFunction()"title="Go to top">
    <img id="up_restaurace_img"src="https://galerie.ulidmanu.cz/down.webp">
        ...
        <div class="info">
            ...
            <div class="info5">
                <div class="text1">
                    <b>Majitel a provozovatel restaurace:
                    </b>
        ...
        <div class="formular"id="formular">
            <div class="form-container">
                    <form name="frmContact" id="" frmContact"" method="post"
                        ...
                        <div class="input-row">
                            <label class="placeHolder">Jméno</label>
                        ...
                        <div class="input-row">
                            <label class="placeHolderPredmet">Předmět</label>
                             <input type="text"placeholder=""
                                 class="input-field-predmet" name="subject" id="subject" />
                                 
                        </div>
                        <div class="input-row">
                            <label class="placeHolderZprava">Zpráva</label>
        ...
        <div class="kraj">
            ...
            <div class="kraj_text">Realizováno za finanční podpory Královéhradeckého kraje</div>
        </div>

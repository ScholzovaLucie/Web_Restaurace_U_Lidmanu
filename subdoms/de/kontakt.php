...
<div class="obrazky"id="obrazky">
        ...
        <a class="active"href="kontakt.php">Hochzeit</a>
        ...
        <a href='rezervace.php'>Reservierung</a>
   ...
   <a id="up_restaurace" onclick="topFunction()"title="Go to top">
    <img id="up_restaurace_img"src="https://galerie.ulidmanu.cz/down.webp">
        ...
        <div class="info1">
            ...
            <div class="info5">
                <div class="text1">
                    <b>Restaurantbesitzer und -betreiber:
                    </b>
        ...
        <div class="formular"id="formular">
            <div class="form-container">
                    <form name="frmContact" id="" frmContact"" method="post"
                        ...
                        <div class="input-row">
                            <label class="placeHolderPredmet">Thema</label>
                             <input type="text"placeholder=""
                                 class="input-field-predmet" name="subject" id="subject" />
                                 
                        </div>
                        <div class="input-row">
                            <label class="placeHolderZprava">Nachricht</label>

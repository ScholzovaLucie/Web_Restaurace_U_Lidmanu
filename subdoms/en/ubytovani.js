...
function balicekclicked(cislo){
   ...
   balicek1.style.height = "6vh";
   balicek2.style.height = "6vh";
   balicek3.style.height = "6vh";
   ...
   switch(cislo) {
      ...
      if(window.innerWidth<1000){
         document.getElementById("balicek1p").innerText= "Prolonged weekend";
         document.getElementById("balicek2p").innerText= "Five-day stay";
         document.getElementById("balicek3p").innerText= "A week's vacation"; 
      }
      else{
         document.getElementById("balicek1p").innerText= "A long weekend in Stolové hory";
         document.getElementById("balicek2p").innerText= "Five-day tourist stay and sightseeing in the region of Machov";
         document.getElementById("balicek3p").innerText= "One week holiday in the Broumovsko region";
      }
      ...
      if(window.innerWidth>600){
         ...
         localbalicekactive.style.top = "29vh";
         localbalicek2.style.top = "29vh";
         localbalicek3.style.top = "29vh";
         ...
         localbalicekactive.style.fontSize= "2vh";
         localbalicek2.style.fontSize= "2vh";
         localbalicek3.style.fontSize= "2vh";
...
function closeBalicek(){
   ...
   if(window.innerWidth<1000){
      document.getElementById("balicek1p").innerText= "A long weekend in Stolové hory (known in English as the Table Mountains)";
      document.getElementById("balicek2p").innerText= "Five-day tourist stay and sightseeing in the region of Machov";
      document.getElementById("balicek3p").innerText= "One week holiday in the Broumovsko region";
   }else{
      document.getElementById("balicek1p").innerText= "A long weekend in Stolové hory (known in English as the Table Mountains)";

...
<div class="obrazky"id="obrazky">
    ...
    <a onmouseleave="hideNodes(this)" id="index_navbar" href='index.html'>O nas</a>
        ...
        <a href='rezervace.php'>Rezerwacja</a>
        <btn onclick="location.href='https://ulidmanu.cz/kontakt.php';" id="jazykCZ"class="jazykCZ">CZ</btn>
    <btn onclick="location.href='https://en.ulidmanu.cz/kontakt.php';" id="jazykEN"class="jazykEN">EN</btn>
    <btn onclick="location.href='kontakt.php';" id="jazykPL"class="jazykPLaktivni">PL</btn>
   ...
   <a id="up_restaurace" onclick="topFunction()"title="Go to top">
    <img id="up_restaurace_img"src="https://galerie.ulidmanu.cz/down.webp">
        ...
        <div class="info">
            ...
            <div class="info5">
                <div class="text1">
                    <b>Właściciel i operator restauracji:
                    </b>
                
                </div>
                <div class="text">
                Petr Šturm
                    <nav></nav> Numer identyfikacyjny: 71143416
                </div>
            </div>

            <div class="info6">
                <div class="text1">
                <b>Operator pensjonatu:</b>
                </div>
                <div class="text">
                Tereza Šturmová
                    <nav></nav> Numer identyfikacyjny: 06841350
                </div>
            </div>
        ...
        <div class="formular"id="formular">
            <div class="form-container">
                    <form name="frmContact" id="" frmContact"" method="post"
                        ...
                        <div class="input-row">
                            <label class="placeHolder">Nazwa</label>
                        ...
                        <div class="input-row">
                            <label class="placeHolderPredmet">Temat</label>
                             <input type="text"placeholder=""
                                 class="input-field-predmet" name="subject" id="subject" />
                                 
                        </div>
                        <div class="input-row">
                            <label class="placeHolderZprava">Wiadomość</label>
        ...
        <div class="kraj">
            ...
            <div class="kraj_text">Zrealizowano przy wsparciu finansowym Kraju Kralowohradeckiego</div>
        </div>

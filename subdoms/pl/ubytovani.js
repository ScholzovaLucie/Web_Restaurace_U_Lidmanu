...
function balicekclicked(cislo){
   ...
   switch(cislo) {
      ...
      if(window.innerWidth<1000){
         document.getElementById("balicek1p").innerText= "Wydłużony weekend";
         document.getElementById("balicek2p").innerText= "Pobyt pięciodniowy";
         document.getElementById("balicek3p").innerText= "Tydzień urlopu"; 
      }
      else{
         document.getElementById("balicek1p").innerText= "Długi weekend w Stolové hory";
         document.getElementById("balicek2p").innerText= "Pięciodniowy pobyt turystyczny i zwiedzanie regionu Machov";
         document.getElementById("balicek3p").innerText= "Tygodniowy urlop w regionie Broumovsko";
      }
...
function closeBalicek(){
   ...
   if(window.innerWidth<1000){
      document.getElementById("balicek1p").innerText= "Długi weekend w Stolové hory (znane w języku angielskim jako Góry Stołowe)";
      document.getElementById("balicek2p").innerText= "Pięciodniowy pobyt turystyczny i zwiedzanie regionu Machov";
      document.getElementById("balicek3p").innerText= "Tygodniowy urlop w regionie Broumovsko";
   } 
   else{

 ...
 *
 * <code>
 * $image = Image::fromFile('nette.webp');
...
class Image
{
	...
	private static $formats = [self::webp => 'webp', self::webp => 'webp', self::GIF => 'gif', self::WEBP => 'webp'];
	 ...
	 * @param  int  quality (0..100 for webp and WEBP, 0..9 for webp)
	...
	public function save($file = null, $quality = null, $type = null)
	{
		if ($type === null) {
			...
			$extensions = array_flip(self::$formats) + ['webp' => self::webp];
	 ...
	 * @return string
	 */
	public function toString($type = self::webp, $quality = null)
	{
		ob_start(function () {});
	 ...
	 * @return bool true on success or false on failure.
	 */
	public function send($type = self::webp, $quality = null)
	{
